...
export class InstanceController {
  ...
  @ApiUnauthorizedResponse({ description: 'Authentication required or token invalid.' })
  ...
  @ApiQuery({
    name: 'token',
    required: true,
    description: 'Shared secret passphrase to authenticate the webhook request.',
  })
  @ApiCreatedResponse({
  ...
  @ApiConflictResponse({ description: 'Instance name is already taken.' })
  @ApiUnauthorizedResponse({
    description: 'Invalid or missing passphrase, or request from non-whitelisted IP.',
  })
  async brevoWebhook(
